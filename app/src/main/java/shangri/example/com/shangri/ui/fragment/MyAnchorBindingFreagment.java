...
/**
 * 主播管理  点击公会跳转的主播列表界面 （freagment界面）
 * Created by admin on 2017/12/22.
 */

public class MyAnchorBindingFreagment extends BaseFragment<NewAnchorView, NewAnchorPresenter> implements NewAnchorView {
    ...
    protected NewAnchorPresenter createPresenter() {
        return new NewAnchorPresenter(getActivity(), this);
    }
    ...
    protected void initViewsAndEvents() {
        ...
        ManagermAdapter = new CommonAdapter<mineAnchorListDataBean.AnchorBean>(getActivity(), mPatrolList, R.layout.company_other_item) {
            @Override
    ...
    private void initSpringView() {
        ...
        sv_partol.setListener(new SpringView.OnFreshListener() {
            ...
            public void onLoadmore() {
                sv_partol.onFinishFreshAndLoad(); //停止加载
//                currPage++;
//                if (!NetWorkUtil.isNetworkConnected(MyAnchorBindingAcvity.getActivity())) {
//                    sv_partol.onFinishFreshAndLoad(); //停止加载
//                } else {
...
//                break;
            ...
            case R.id.tv_fast_ident:
                Intent intent = new Intent(getActivity(), FastAnchorBindingActivity.class);
