...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "6jgggOxwud7oIcdIZLAPf6Lz";
    public static String secretKey = "CN3CeKB03hTbVusBdE374Dh71Gb7MvAp";
    public static String licenseID = "LiveHome-face-android";
