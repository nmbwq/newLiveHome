...
public class BossAdapter extends BaseListAdapter<BossDataBean.ListBean.DataBean> {

    private Context mContext;
    private Animation mLikeAnim;


    public BossAdapter(Context context, int layoutId, List<BossDataBean.ListBean.DataBean> datas) {
