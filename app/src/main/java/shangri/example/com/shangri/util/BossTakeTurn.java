...
public class BossTakeTurn {
    private List<BanagetBean.BannerBean> mBannerInfoBeanList = new ArrayList<>();
    public BossTakeTurn(Context context, List<BanagetBean.BannerBean> bannerInfoBeanList,
        ...
        convenientBanner.setPages(new CBViewHolderCreator<BossTakeTurn.NetworkImageHolderView>() {
            @Override
            public BossTakeTurn.NetworkImageHolderView createHolder() {
                return new BossTakeTurn.NetworkImageHolderView();
            }
