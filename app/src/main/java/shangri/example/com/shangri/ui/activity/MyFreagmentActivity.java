...
public class MyFreagmentActivity extends BaseActivity<MyGuildView, MyGuildPresenter> implements MyGuildView {
    @BindView(R.id.setting_back)
    ImageView settingBack;

    @Override
    protected int getNormalLayoutId() {
        return R.layout.my_manager_freagment_activity;
    }
