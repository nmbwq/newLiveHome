package shangri.example.com.shangri.CitySelect.db.manager;
...
import shangri.example.com.shangri.CitySelect.db.AssetsDatabaseManager;
import shangri.example.com.shangri.CitySelect.db.TableField;

import static shangri.example.com.shangri.CitySelect.db.TableField.ADDRESS_DICT_FIELD_CODE;
import static shangri.example.com.shangri.CitySelect.db.TableField.ADDRESS_DICT_FIELD_ID;
import static shangri.example.com.shangri.CitySelect.db.TableField.ADDRESS_DICT_FIELD_PARENTID;
...
public class AddressDictManager {
    ...
    public List<Province> getProvinceList() {
        ...
        while (cursor.moveToNext()) {
            ...
            if (!province.name.contains("测试") && province.name.length() > 0) {
