...
public class AnchorCollectNewBossFragment extends BaseFragment<BossFragmentView, BossFragmentPresenter> implements BossFragmentView, View.OnClickListener {
    @Override
