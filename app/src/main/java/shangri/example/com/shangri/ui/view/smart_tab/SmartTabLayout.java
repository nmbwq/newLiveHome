 ...
 */
package shangri.example.com.shangri.ui.view.smart_tab;
...
public class SmartTabLayout extends HorizontalScrollView {
  ...
  private static final int TAB_VIEW_TEXT_COLOR = 0xff333333;
  private static final int TAB_VIEW_TEXT_SELECTED_COLOR = 0xffff6c00;
  ...
  private void populateTabStrip() {
    ...
    for (int i = 0; i < adapter.getCount(); i++) {
      ...
      if(i == 0){
        ...
        tabTextView.setTextColor(ColorStateList.valueOf(TAB_VIEW_TEXT_SELECTED_COLOR));
      }
  ...
  private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
    ...
    public void onPageSelected(int position) {
      ...
      for (int i = 0, size = tabStrip.getChildCount(); i < size; i++) {
        TextView tabView = (TextView) tabStrip.getChildAt(i);
          if(position == i){
          tabView.setSelected(true);
          tabView.setTextColor(ColorStateList.valueOf(TAB_VIEW_TEXT_SELECTED_COLOR));
        }else{
          tabView.setTextColor(ColorStateList.valueOf(TAB_VIEW_TEXT_COLOR));
        }
...
//          tabView.setTextColor(ColorStateList.valueOf(TAB_VIEW_TEXT_SELECTED_COLOR)); //修改点击选中的颜色
