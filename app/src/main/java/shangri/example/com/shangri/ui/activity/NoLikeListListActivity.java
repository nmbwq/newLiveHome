...
public class NoLikeListListActivity extends BaseActivity<LowWorksPayView, LawWorksPayPresenter> implements LowWorksPayView {
    ...
    //列表
    private List<BossDataBean.ListBean.DataBean> mList = new ArrayList<>();
    ...
    protected void onResume() {
        super.onResume();
        if (!NetWorkUtil.isNetworkConnected(NoLikeListListActivity.this)) {
            ...
            currPage = 1;
            mPresenter.noLikeList(currPage+"");
        }
    }
    ...
    protected void initViewsAndEvents() {
        ...
        rv_partol.setLayoutManager(new FastLinearScrollManger(NoLikeListListActivity.this));
        mAdapter = new BossAdapter(this, R.layout.item_boss, mList);
