...
public class TaskStateSerchAdapter extends BaseListAdapter<partSelectBean.PersonsBean> {

    private Context mContext;
    private Animation mLikeAnim;
    String Title;

    public TaskStateSerchAdapter(Context context, int layoutId, List<partSelectBean.PersonsBean> datas, String title) {
    ...
    @Override
    public void convert(ViewHolder helper, partSelectBean.PersonsBean noJoinBean) {
    ...
    @Override
    public void convert(ViewHolder helper, partSelectBean.PersonsBean personsBean, List<Object> payloads) {
