...
public abstract class HaveDetailFastClickBaseListAdapter<T> extends RecyclerView.Adapter<ViewHolder> implements DataIO<T> {
    ...
    public HaveDetailFastClickBaseListAdapter(Context context, int layoutId, List<T> datas) {
        mContext = context;
    ...
    public HaveDetailFastClickBaseListAdapter(Context context, int layoutId) {
        mContext = context;
        mInflater = LayoutInflater.from(context);
        mLayoutId = layoutId;
        pageBean = new PageBean();
