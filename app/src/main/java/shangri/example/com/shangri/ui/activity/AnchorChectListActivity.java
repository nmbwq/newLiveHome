...
public class AnchorChectListActivity extends BaseActivity<anchorChectView, anchorChectPresenter> implements anchorChectView, AnchorChectFace {
    ...
    protected void initViewsAndEvents() {
        ...
        title.setText("主播申请");
        rv_partol.setLayoutManager(new FastLinearScrollManger(AnchorChectListActivity.this));
        mAdapter = new AnchorChectAdapter(this, R.layout.item_my_checkanchor, mPatrolList, CompanyInterfaceUtils.anchorChectFace);
    ...
    public void loadData() {
        if (!NetWorkUtil.isNetworkConnected(AnchorChectListActivity.this)) {
...
//
    ...
    public AlertDialog homeDialog1(final String register_guild_id) {
        View view = LayoutInflater.from(AnchorChectListActivity.this).inflate(R.layout.refuse_dialog_layout, null);
        ...
        //点击事件
        dialog = new AlertDialog.Builder(AnchorChectListActivity.this).create();
        dialog.show();
        ...
        window.setLayout(dip2px(AnchorChectListActivity.this, 330), -1);
        dialog.setCanceledOnTouchOutside(false);
        //使弹出输入法
        InputMethodManager im2 = (InputMethodManager) AnchorChectListActivity.this
