...
public abstract class BasePopupWindow extends PopupWindow {
    ...
    protected String mBottomContent;
    public BasePopupWindow(Context context, String bottomContent) {
        this.mContext = context;
        mBottomContent = bottomContent;
        initBasePopupWindow(context);
    }
     ...
     * */
    private void initBasePopupWindow(Context context) {
