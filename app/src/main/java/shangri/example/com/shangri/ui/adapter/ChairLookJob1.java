...
public class ChairLookJob1 extends BaseListAdapter<AllListBean.ListBean> {
    ...
    public ChairLookJob1(Context context, int layoutId, List<AllListBean.ListBean> datas, RightToLeft rightToLeft) {
    ...
    @Override
    public void convert(final ViewHolder helper, final AllListBean.ListBean data) { //, List<Object> payloads
...
//                        iv_collect.setImageResource(R.mipmap.d11);
    ...
    @Override
    public void convert(ViewHolder helper, AllListBean.ListBean data, List<Object> payloads) {
    }
