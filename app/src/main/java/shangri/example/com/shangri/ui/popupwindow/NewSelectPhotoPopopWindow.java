...
public class NewSelectPhotoPopopWindow extends BasePopupWindow {

    private SelectPhotoListener mSelectPhotoListener;
    public String text1 = "";
    public String text2 = "";

    public NewSelectPhotoPopopWindow(Context context, SelectPhotoListener selectPhotoListener, String bottomContent) {
    ...
    protected int getLayoutId() {
        return R.layout.newpopupwindow_select_photo;
    }
