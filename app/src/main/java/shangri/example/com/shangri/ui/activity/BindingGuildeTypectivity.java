...
public class BindingGuildeTypectivity extends BaseActivity<BindingGuildView, BindingGuildPresenter> implements BindingGuildView {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_fast_ident:
                startActivity(new Intent(BindingGuildeTypectivity.this, FastBindingActivity.class));
                break;
            case R.id.tv_platfrom_ident:
                startActivity(new Intent(BindingGuildeTypectivity.this, BindingActivity.class));
                break;
