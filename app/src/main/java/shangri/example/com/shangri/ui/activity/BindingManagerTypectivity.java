...
public class BindingManagerTypectivity extends BaseActivity<BindingGuildView, BindingGuildPresenter> implements BindingGuildView {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_platfrom_ident:
                startActivity(new Intent(BindingManagerTypectivity.this, CompanyListActivity.class));
                break;
...
//        //显示PopupWindow
        ...
        re_fast_list.setVisibility(View.GONE);
