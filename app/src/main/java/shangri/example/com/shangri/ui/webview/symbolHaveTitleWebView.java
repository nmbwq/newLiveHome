 ...
 */
public class symbolHaveTitleWebView extends BaseActivity<CultivateLikeView, CultivatLikePresenter> implements CultivateLikeView {
    ...
    protected int getNormalLayoutId() {
        return R.layout.havetitlewebview;
    }
