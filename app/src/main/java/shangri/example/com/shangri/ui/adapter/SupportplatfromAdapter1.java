...
public class SupportplatfromAdapter1 extends BaseListAdapter<SupportFromList.QuickPlatfromBean> {

    public SupportplatfromAdapter1(Context context, int layoutId, List<SupportFromList.QuickPlatfromBean> datas) {
    ...
    @Override
    public void convert(ViewHolder helper, SupportFromList.QuickPlatfromBean data) { //, List<Object> payloads
...
//                .into(view);
    ...
    @Override
    public void convert(ViewHolder helper, SupportFromList.QuickPlatfromBean tipsPageDataBean, List<Object> payloads) {
