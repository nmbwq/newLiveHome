...
public class HeadTakeTurn {
    private List<HeadLinesData.BannersBean> mBannerInfoBeanList = new ArrayList<>();
    public HeadTakeTurn(Context context, List<HeadLinesData.BannersBean> bannerInfoBeanList,
        ...
        convenientBanner.setPages(new CBViewHolderCreator<HeadTakeTurn.NetworkImageHolderView>() {
            @Override
            public HeadTakeTurn.NetworkImageHolderView createHolder() {
                return new HeadTakeTurn.NetworkImageHolderView();
            }
    ...
    class NetworkImageHolderView implements Holder<HeadLinesData.BannersBean> {
        ...
        @Override
        public void UpdateUI(Context context, int position, HeadLinesData.BannersBean data) {
