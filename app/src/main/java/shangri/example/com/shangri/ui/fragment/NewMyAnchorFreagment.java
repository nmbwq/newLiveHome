...
public class NewMyAnchorFreagment extends BaseFragment<MyTaskView, MyTaskPresenter> implements MyTaskView {
    ...
    protected MyTaskPresenter createPresenter() {
        return new MyTaskPresenter(getActivity(), this);
    }
...
//        initSpringView();
        ...
        mAdapter = new MyAnchorTypeAdapter(getActivity(), R.layout.my_anchor_type_item, mNewsList, 1);
        mAdapter.openLoadAnimation(new ScaleInAnimation());
        FastmAdapter = new MyAnchorTypeAdapter(getActivity(), R.layout.my_anchor_type_item1, FastNewsList, 2);
