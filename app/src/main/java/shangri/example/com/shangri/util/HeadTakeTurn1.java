...
public class HeadTakeTurn1 {
    private List<VIPBannerBean.Banner> mBannerInfoBeanList = new ArrayList<>();

    public HeadTakeTurn1(Context context, List<VIPBannerBean.Banner> bannerInfoBeanList,
        ...
        convenientBanner.setPages(new CBViewHolderCreator<HeadTakeTurn1.NetworkImageHolderView>() {
            @Override
            public HeadTakeTurn1.NetworkImageHolderView createHolder() {
                return new HeadTakeTurn1.NetworkImageHolderView();
            }
    ...
    class NetworkImageHolderView implements Holder<VIPBannerBean.Banner> {
        ...
        @Override
        public void UpdateUI(Context context, int position, VIPBannerBean.Banner data) {
            BitmapCache.getInstance().loadBitmaps(imageView, data.getImage_url(), null);
