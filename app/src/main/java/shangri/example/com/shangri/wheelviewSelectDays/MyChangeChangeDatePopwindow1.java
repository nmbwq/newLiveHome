 ...
 */
public class MyChangeChangeDatePopwindow1 extends PopupWindow implements View.OnClickListener {
    ...
    public MyChangeChangeDatePopwindow1(final Context context, int symbol1, final ArrayList<String> list_months, final ArrayList<String> list_days) {
        super(context);
...
//		this.setAnimationStyle(R.style.AnimBottom);
        ...
        wvMonth.addScrollingListener(new OnWheelScrollListener() {
            ...
            public void onScrollingFinished(WheelView wheel) {
                ...
                for (int i = 0; i < list_days.size(); i++) {
                    if (Integer.parseInt(list_days.get(i).replace("K", "")) > Integer.parseInt(currentText.replace("K", ""))) {
                        arry_days.add(list_days.get(i));
                    }
                }
                DefaultPositionDay = 0;
                Log.d("Debug", "返回的数据个数" + arry_days.size());
                mDaydapter = new CalendarTextAdapter(context, arry_days, DefaultPositionDay, maxTextSize, minTextSize);
                wvDay.setVisibleItems(5);
                wvDay.setViewAdapter((WheelViewAdapter) mDaydapter);
                wvDay.setCurrentItem(DefaultPositionDay);
    ...
    private class CalendarTextAdapter extends AbstractWheelTextAdapter1 {
        ...
        public void setDate(ArrayList<String> newlist) {
            list = newlist;
