...
//        已沟通数
    ...
    String hf_bd;
    //    已投简历数
    String send_resume_total;


    //    今日是否签到  0是没有签到  1是已签到
    String is_today_sign;
    ...
    public String getSend_resume_total() {
        return send_resume_total;
    }
    ...
    public void setIs_today_sign(String is_today_sign) {
    ...
    public void setSend_resume_total(String send_resume_total) {
        this.send_resume_total = send_resume_total;
    }
