...
public class PlatSelectAdapter extends BaseListAdapter<BossPlatBean.PlatfromBean> {

    private Context mContext;
    private Animation mLikeAnim;


    public PlatSelectAdapter(Context context, int layoutId, List<BossPlatBean.PlatfromBean> datas) {
