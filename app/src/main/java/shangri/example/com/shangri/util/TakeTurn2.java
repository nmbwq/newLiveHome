...
public class TakeTurn2 {
    private List<EncyclopediaHomeBean.BannersBean> mBannerInfoBeanList = new ArrayList<>();

    public TakeTurn2(Context context, List<EncyclopediaHomeBean.BannersBean> bannerInfoBeanList,
        ...
        convenientBanner.setPages(new CBViewHolderCreator<TakeTurn2.NetworkImageHolderView>() {
            @Override
            public TakeTurn2.NetworkImageHolderView createHolder() {
                return new TakeTurn2.NetworkImageHolderView();
            }
    ...
    class NetworkImageHolderView implements Holder<EncyclopediaHomeBean.BannersBean> {
        ...
        @Override
        public void UpdateUI(Context context, int position, EncyclopediaHomeBean.BannersBean data) {
