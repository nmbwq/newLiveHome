 ...
 */
public class CommentDetailWebView extends BaseActivity<CultivateLikeView, CultivatLikePresenter> implements CultivateLikeView {
...
//    //true 为回复操作  false为 添加评论
//    boolean isBoolHuifu = false;
    ...
    protected int getNormalLayoutId() {
        return R.layout.activity_commentdetail_webview;
    }
...
//        http://www.zhibohome.net/reply/#/?token=WTC0SIvJ19W7Se1m1S1S&comment_id=1,143,1,电风扇
    ...
    public void comment() {
        ...
        Toast.makeText(CommentDetailWebView.this, "发表成功", Toast.LENGTH_LONG).show();
...
//        });
        //调用web方法
        webView.loadUrl("javascript:senlist()");
        dialog.dismiss();
    }
    ...
    @OnClick({R.id.reload, R.id.webview_back, R.id.rl_commit})
            ...
            public void sendBack(final String inputText) {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        mProgressDialog.show(CommentDetailWebView.this.getSupportFragmentManager());
                        if (type.equals("1")) {
