...
public class FocusFragment extends BaseLazyFragment<NewsTypeView, NewsTypePresenter> implements NewsTypeView {
...
//    Button reload;
    ...
    private CollectHeadlineFreagment fragment1;
    private CollectPeiXunFreagment fragment;
    private InterlocutionFreagment fragment2;
    ...
    private void createPager() {
        ...
        channelNames.add("公会");
        channelNames.add("主播");
        mNewsFragmentList.add(MyFocusFreagment.getInstance(1));
        mNewsFragmentList.add(MyFocusFreagment.getInstance(2));
        mNewsFragmentList.add(MyFocusFreagment.getInstance(3));
