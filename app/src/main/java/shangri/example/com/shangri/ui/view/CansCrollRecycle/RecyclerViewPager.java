...
import shangri.example.com.shangri.BuildConfig;
...
public class RecyclerViewPager extends RecyclerView {
    ...
    public boolean fling(int velocityX, int velocityY) {
        ...
        if (DEBUG) {
            ...
            if (mOnPageChangedListeners != null) {
                if (mOnPageChangedListeners.get(0) != null) {
                    mOnPageChangedListeners.get(0).OnPageChanged(-1, -1);
                }
            }
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        Log.d("Debug","到达MotionEvent.ACTION_MOVE改变外面");

        if (e.getAction() == MotionEvent.ACTION_MOVE) {
            Log.d("Debug","到达MotionEvent.ACTION_MOVE改变里面");
            if (mCurView != null) {
    ...
    public void onScrollStateChanged(int state) {
        ...
        Log.d("Debug","到达onScrollStateChanged改变里面");
        if (state == SCROLL_STATE_DRAGGING) {
            ...
            if (mNeedAdjust) {
                ...
                if (DEBUG) {
                    Log.d("@", "onPageChanged:" + mSmoothScrollTargetPosition + "  mPositionBeforeScroll = " + mPositionBeforeScroll);
