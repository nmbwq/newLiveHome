...
public class GouTongNewBossFragment extends BaseFragment<BossFragmentView, BossFragmentPresenter> implements BossFragmentView, View.OnClickListener {
    @Override
...
//                request();
    ...
    protected int getNormalLayoutId() {
        return R.layout.activity_collect_interlocution2;
    }
