...
public class PayMyGuildAdapter extends BaseListAdapter<MyGuildListDataBean.GuildsBean> {
    public PayMyGuildAdapter(Context context, int layoutId, List<MyGuildListDataBean.GuildsBean> datas) {
        super(context, layoutId, datas);
    }

    //item全部刷新
    @Override
    public void convert(ViewHolder helper, MyGuildListDataBean.GuildsBean myGuildListBean) {
