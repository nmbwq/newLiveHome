...
//    private static final String BASE_URL = "http://jz.zhibohome.net/";//换成你上传用的服务器地址
    private static final String BASE_URL = "http://test.ilivehome.net/";//测试
//    /**
//     * 版本升级
//     */
//    public static final String URL_APP_GETVERSIONS = BASE_URL + "api/appVersion/getTheLast";
...
//        }
        //缓存
        File cacheFile = new File(GlobalApp.getAppContext().getCacheDir(), "cache");
