...
import shangri.example.com.shangri.ui.adapter.ListBeanAdapter1;
import shangri.example.com.shangri.ui.adapter.WelfareGuildAdapter;
 ...
 * Author: lin
 */
public class ResumeManage3Fragment extends BaseFragment<ResumeManageView, ResumeManagePresent> implements ResumeManageView {
    ...
    public void getGuildList(WelfareGuildBean welfareGuildBean) {
        ...
        mList.clear();
        if (welfareGuildBean.getResume().size() > 0) {
        ...
        mAdapter.addAll(welfareGuildBean.getResume());
